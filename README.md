...
- The essence of this whole project can be found in the 'stream-to-bq.py' file.  If you've used Lambda for Python before, you could probably just get started by adapting that file to your needs.  If you're having trouble with the 'self contained zip file' described above, you should be able just to download this whole repo as a zip file to get you started - as it contains all the dependencies for a working Lambda function.
